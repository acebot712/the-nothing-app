  ...
  const renderPlaceholder = () => {
    ...
    return (
      <LinearGradient
        ...
        style={[styles.placeholder, dynamicPlaceholderStyle]}
      >
  ...
  const avatarContent = (
    <View style={[styles.container, dynamicContainerStyle, containerStyle]}>
      {source ? (
        <Image
          source={{ uri: source }}
          style={[styles.image, dynamicImageStyle, imageStyle]}
          resizeMode="cover"
        />
      ) : (
        renderPlaceholder()
      ...
      {status && <View style={[styles.statusIndicator, dynamicStatusStyle]} />}
    </View>
  );
