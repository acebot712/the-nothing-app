  ...
  const handlePayment = async () => {
    try {
      ...
      try {
        ...
        console.error('Stripe payment error, falling back to mock:', stripeError);
        ...
        Alert.alert(
          ...
          "We're having trouble with our payment processor. For demo purposes, we'll simulate a successful payment.",
          [
            {
              text: "Cancel",
              style: "cancel",
