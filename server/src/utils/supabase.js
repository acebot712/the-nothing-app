...
const initializeDatabase = async () => {
  try {
    ...
    if (leaderboardCheckError && leaderboardCheckError.code === '42P01') {
      ...
      const { error: createLeaderboardError } = await supabaseAdmin.rpc('create_tables', {
        sql: `
      ...
      const sampleData = [
        { id: '11111111-1111-1111-1111-111111111111', username: 'Elon M.', purchase_amount: 99999, tier: 'god' },
        { id: '22222222-2222-2222-2222-222222222222', username: 'Jeff B.', purchase_amount: 99999, tier: 'god' },
        { id: '33333333-3333-3333-3333-333333333333', username: 'Mark Z.', purchase_amount: 9999, tier: 'elite' },
        { id: '44444444-4444-4444-4444-444444444444', username: 'Bill G.', purchase_amount: 9999, tier: 'elite' },
        { id: '55555555-5555-5555-5555-555555555555', username: 'Warren B.', purchase_amount: 999, tier: 'regular' }
      ];
      ...
      if (insertError) {
        logger.error(`Error inserting sample leaderboard data: ${insertError.message}`);
      }
    }
